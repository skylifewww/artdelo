...
@task
def prod():
    env.prefix = 'source /home/webmaster/.virtualenvs/iosDevCourse/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['iosDevCourse.com']
    env.path = '/home/webmaster/apps/iosDevCourse'
    env.branch = 'master'
    env.db_name = 'iosDevCourse'
    env.app = 'iosDevCourse'
...
def test():
    env.prefix = 'source /home/webmaster/.virtualenvs/iosDevCourse/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['test.iosDevCourse.com']
    env.path = '/home/webmaster/apps/iosDevCourse'
    env.branch = 'master'
    env.db_name = 'iosDevCourse'
    env.app = 'iosDevCourse'
